...
class BoltHumanoidRobot(PinBulletWrapper):
    def __init__(
        self,
        pos=None,
        orn=None,
        ...
        pybullet.setAdditionalSearchPath(BoltHumanoidConfig.resources.package_path)
        self.urdf_path = BoltHumanoidConfig.urdf_path
        self.simu_urdf_path = BoltHumanoidConfig.simu_urdf_path
        if self.is_passive:
        ...
        self.pin_robot = BoltHumanoidConfig.buildRobotWrapper()
        if self.is_passive:
            self.simu_pin_robot = BoltHumanoidConfig.buildSimuRobotWrapper()
    ...
    def send_joint_command(self, tau):
        if self.is_passive:
            ...
            super(BoltHumanoidRobot, self).send_joint_command(tau_simu)
        else:
            super(BoltHumanoidRobot, self).send_joint_command(tau)
